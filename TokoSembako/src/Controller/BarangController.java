...
public class BarangController {
    ...
    public ArrayList<Barang> getDataBarang(Barang p) throws SQLException {
       ...
       ResultSet rs = this.koneksi.GetData("SELECT BARANG.*, JENIS_BARANG.* FROM BARANG JOIN JENIS_BARANG ON BARANG.ID_JENISBARANG = JENIS_BARANG.ID_JENISBARANG ORDER BY ID_BARANG ASC");
